...
You can specify the number of columns in the faceted plot however, and you can also specify the breaks for date labels on the x axis.
...
Th package allows for finding runs in both directions (above and below the median). 
