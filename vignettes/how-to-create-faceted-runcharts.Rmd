...
This example follows on from the previous example, "How to create multiple runcharts".

We will start with exactly the same approach. The difference is that we will then extract items from the created dataframe to build a faceted plot. 
