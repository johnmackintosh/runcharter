...
The package  will only identify a run in one direction at a time. 
...
I have over 2000 run charts that I need to produce and analyse. 
I needed this solution. I'm confident that in time others will realise they need it too.
 


## I don't like the default chart colours

Use the package to do the analysis, take the outputs, and build your own plots.
Or assign the function outputs to a variable, retrieve the runchart object, and add additional ggplot2 syntax to modify it to suit your preferences. 
I've let ggplot2 handle faceting and the axis limits in order keep the function simple.
This means you can add additional scale syntax to control date breaks, limits and formats.
