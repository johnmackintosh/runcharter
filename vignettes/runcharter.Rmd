...
p$runchart # display the plot

class(p$sustained) # results are class data.table and dataframe
p$sustained
...
```{r, fig.height=5, fig.width =8, fig.show='hold',fig.cap = "One location showing a run below the median"}
library(runcharter)
