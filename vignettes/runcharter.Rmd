...
By popular request (two people), finding runs in both directions is now implemented:
...
The package now allows for finding runs in both directions (above and below the median). 
However, for improvement purposes, you would nearly always only need to identify runs in one direction at a time. 
...
If you want to apply the rules for trend then you should consider using Joseph Adam's 'runchart' package.
