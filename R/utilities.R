utils::globalVariables(c("Baseline", "Date", "EndDate", "StartBaseline", "baseline", "chart_title" ,"data","df",
                         ...
                         "med_rows","median_rows","out_group","runcharts", "rungroup", "runlength",
                         "sp", "plot_ext","tmpdata", "y"))
...
build_facet <- function(df, mr, rl,ct,cs,direct, n_facets,sp, plot_extension, ...) {
